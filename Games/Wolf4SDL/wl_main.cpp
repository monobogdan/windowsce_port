...
wolfboolean startgame;
wolfboolean loadedgame;
int     mouseadjustment;
...
//
wolfboolean param_debugmode = false;
wolfboolean param_nowait = false;
...
int     param_mission = 0;
wolfboolean param_goodtimes = false;
wolfboolean param_ignorenumchunks = false;
...
void ReadConfig(void)
{
    ...
    if (!file)
    {
        ...
        wolfboolean dummyJoypadEnabled;
        read(file,&dummyJoypadEnabled,sizeof(dummyJoypadEnabled));
        wolfboolean dummyJoystickProgressive;
...
void WriteConfig(void)
{
    ...
    if (!file)
    {
        ...
        wolfboolean dummyJoypadEnabled = false;
        write(file,&dummyJoypadEnabled,sizeof(dummyJoypadEnabled));
        wolfboolean dummyJoystickProgressive = false;
