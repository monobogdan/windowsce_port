...
FILE*    grhandle = 0;               // handle to EGAGRAPH
FILE*    maphandle = 0;              // handle to MAPTEMP / GAMEMAPS
FILE*    audiohandle = 0;            // handle to AUDIOT / AUDIO
...
wolfboolean CA_WriteFile (const char *filename, void *ptr, int32_t length)
{
...
wolfboolean CA_LoadFile (const char *filename, memptr *ptr)
{
    int32_t size;
