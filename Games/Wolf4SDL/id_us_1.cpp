...
void US_Printf(const char *formatStr, ...)
{
    ...
    int len = vsprintf(strbuf, formatStr, vlist);
    va_end(vlist);
...
{
	static	wolfboolean	status;		// VGA doesn't XOR...
	char	buf[MaxString];
	int		temp;
	word	w,h;
...
///////////////////////////////////////////////////////////////////////////
wolfboolean
US_LineInput(int x,int y,char *buf,const char *def,wolfboolean escok,
