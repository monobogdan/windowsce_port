...
//
...
#endif
    {
        ...
        Write (26, 2, _itoa (gamestate.mapon + 1, tempstr, 10));
#endif
        ...
        if (bonus)
        {
            ...
            {
                _ltoa ((int32_t) i * PAR_AMOUNT, tempstr, 10);
