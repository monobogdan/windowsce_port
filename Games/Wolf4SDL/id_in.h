...
typedef	struct		{
						wolfboolean		button0,button1,button2,button3;
						short		x,y;
						Motion		xaxis,yaxis;
						Direction	dir;
					} CursorInfo;
...
// Global variables
extern  volatile wolfboolean    Keyboard[];
extern           wolfboolean    MousePresent;
extern  volatile wolfboolean    Paused;
extern  volatile char       LastASCII;
extern  volatile ScanCode   LastScan;
extern           int        JoyNumButtons;
extern           wolfboolean    forcegrabmouse;
...
extern	void		IN_StopDemo(void),IN_FreeDemoBuffer(void),
					IN_Ack(void);
extern	wolfboolean		IN_UserInput(longword delay);
