...
//      Internal variables
static  wolfboolean                 SD_Started;
static  wolfboolean                 nextsoundpos;
...
static  wolfboolean                 DigiPlaying;
...
//      Sequencer variables
static  volatile wolfboolean        sqActive;
static  word                   *sqHack;
...
void SDL_IndicatePC(wolfboolean ind)
{
        pcindicate=ind;
}
...
static void
#endif
SDL_PCPlaySample(byte *data,longword len,wolfboolean inIRQ)
{
        if(!inIRQ)
        {
//              _asm    pushfd
