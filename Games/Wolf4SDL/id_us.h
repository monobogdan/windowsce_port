...
extern	wolfboolean		ingame,		// Set by game code if a game is in progress
...
extern	wolfboolean		(*USL_SaveGame)(int),(*USL_LoadGame)(int);
...
extern	wolfboolean	US_UpdateCursor(void);
wolfboolean         US_LineInput(int x,int y,char *buf,const char *def,wolfboolean escok,
