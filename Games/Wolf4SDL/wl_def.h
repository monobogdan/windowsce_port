...
typedef struct
{
    ...
    int32_t     TimeCount;
    int32_t     killx,killy;
    wolfboolean     victoryflag;            // set during victory animations
} gametype;
...
//
extern  wolfboolean  param_debugmode;
extern  wolfboolean  param_nowait;
...
extern  wolfboolean  param_goodtimes;
extern  wolfboolean  param_ignorenumchunks;


void            NewGame (int difficulty,int episode);
void            CalcProjection (int32_t focal);
void            NewViewSize (int width);
wolfboolean         SetViewSize (unsigned width, unsigned height);
wolfboolean         LoadTheGame(FILE *file,int x,int y);
wolfboolean         SaveTheGame(FILE *file,int x,int y);
...
extern  wolfboolean     buttonstate[NUMBUTTONS];
extern  objtype     objlist[MAXACTORS];
extern  wolfboolean     buttonheld[NUMBUTTONS];
extern  exit_t      playstate;
extern  wolfboolean     madenoise;
...
extern  wolfboolean     demorecord,demoplayback;
...
// control info
//
extern  wolfboolean     mouseenabled,joystickenabled;
...
extern  wolfboolean     noclip,ammocheat;
...
extern  wolfboolean fizzlein, fpscounter;
...
wolfboolean TryWalk (objtype *ob);
void    SelectChaseDir (objtype *ob);
void    SelectDodgeDir (objtype *ob);
void    SelectRunDir (objtype *ob);
void    MoveObj (objtype *ob, int32_t move);
wolfboolean SightPlayer (objtype *ob);

void    KillActor (objtype *ob);
void    DamageActor (objtype *ob, unsigned damage);

wolfboolean CheckLine (objtype *ob);
wolfboolean CheckSight (objtype *ob);
...
extern  wolfboolean   areabyplayer[NUMAREAS];
...
void SpawnDoor (int tilex, int tiley, wolfboolean vertical, int lock);
void MoveDoors (void);
