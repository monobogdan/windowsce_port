...
// Global variables
extern  wolfboolean         AdLibPresent,
                        SoundBlasterPresent,
                        SoundPositioned;
...
extern  wolfboolean SD_PlaySound(soundnames sound);
...
extern  wolfboolean SD_MusicPlaying(void);
extern  wolfboolean SD_SetSoundMode(SDMode mode);
extern  wolfboolean SD_SetMusicMode(SMMode mode);
