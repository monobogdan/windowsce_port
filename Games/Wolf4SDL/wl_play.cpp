...
wolfboolean madenoise;              // true when shooting or screaming
...
// control info
//
wolfboolean mouseenabled, joystickenabled;
...
wolfboolean buttonheld[NUMBUTTONS];

wolfboolean demorecord, demoplayback;
...
wolfboolean buttonstate[NUMBUTTONS];
